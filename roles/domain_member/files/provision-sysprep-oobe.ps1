...
$Host.UI.RawUI.WindowTitle = 'WARNING :: provision-sysprep-oobe :: do NOT touch anything :: WARNING'

Write-ProvisionProgress @"


WARNING WARNING WARNING WARNING WARNING WARNING

         this is being run by sysprep
...
Write-ProvisionProgress 'Disabling auto logon...'
Add-Type @"
using System;
...
Write-ProvisionProgress 'Signaling the provision-sysprep completion...'
$provisionSysprepCompletedPath = 'C:\Windows\System32\Sysprep\provision-sysprep.txt'
Set-Content `
    -Encoding UTF8 `
    -NoNewLine `
    -Path $provisionSysprepCompletedPath `
    -Value ''

Write-ProvisionProgress 'Logging out...'
logoff
