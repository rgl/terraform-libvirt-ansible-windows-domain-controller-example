...
# when already completed, bail.
# NB this is created by provision-sysprep-oobe.ps1.
$provisionSysprepCompletedPath = 'C:\Windows\System32\Sysprep\provision-sysprep.txt'
if (Test-Path $provisionSysprepCompletedPath) {
    Exit 0
}

# ensure the sysprep oobe script exists.
# NB this was uploaded by a task in main.yml.
$provisionSysprepOobePath = 'C:\Windows\System32\Sysprep\provision-sysprep-oobe.ps1'
if (!(Test-Path $provisionSysprepOobePath)) {
    throw "$provisionSysprepOobePath not found"
}
...
# wait for cloudbase-init to finish.
Write-ProvisionProgress 'Waiting for cloudbase-init to finish...'
while ((Get-Service cloudbase-init).Status -ne 'Stopped') {
    Start-Sleep -Seconds 5
}
    ...
    <settings pass="oobeSystem">
        ...
        <component name="Microsoft-Windows-Shell-Setup" processorArchitecture="amd64" publicKeyToken="31bf3856ad364e35" language="neutral" versionScope="nonSxS" xmlns:wcm="http://schemas.microsoft.com/WMIConfig/2002/State" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            ...
            <AutoLogon>
                ...
                <Username>$($autoLogonCredential.UserName)</Username>
                <Password>
                    <Value>$([System.Security.SecurityElement]::Escape($autoLogonCredential.GetNetworkCredential().Password))</Value>
            ...
            <FirstLogonCommands>
                <SynchronousCommand wcm:action="add">
                    <Order>1</Order>
                    <CommandLine>PowerShell -WindowStyle Maximized -File $provisionSysprepOobePath</CommandLine>
                </SynchronousCommand>
            </FirstLogonCommands>
        </component>
    </settings>
